      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        <div className="bg-white dark:bg-[#1a1c23] rounded-2xl shadow-sm border border-gray-200 dark:border-white/5 p-6 min-h-[160px] md:min-h-[200px] transition-all duration-300 relative overflow-hidden flex flex-col justify-between">
          ...
          <div className="absolute bottom-4 right-4 sm:bottom-6 sm:right-6">
            <CircularProgress percentage={totalPlanned > 0 ? 100 : 0} color="blue" size={42} />
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#1a1c23] rounded-2xl shadow-sm border border-gray-200 dark:border-white/5 p-6 min-h-[160px] md:min-h-[200px] transition-all duration-300 relative overflow-hidden flex flex-col justify-between">
          <div className="mb-4">
            <p className="text-sm font-medium text-gray-600 dark:text-gray-400 flex items-center justify-between w-full">
              Producción Total
              <span className="hidden sm:inline-block text-[10px] bg-blue-100 dark:bg-blue-500/20 text-blue-700 dark:text-blue-400 px-1.5 py-0.5 rounded-full font-bold uppercase tracking-wider transition-all duration-300">Bandejas</span>
            </p>
            <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mt-1">
          ...
          <div className="absolute bottom-4 right-4 sm:bottom-6 sm:right-6 flex items-center gap-2">
            <span className="sm:hidden text-[10px] bg-blue-100 dark:bg-blue-500/20 text-blue-700 dark:text-blue-400 px-1.5 py-0.5 rounded-full font-bold uppercase tracking-wider">Bandejas</span>
            <CircularProgress percentage={compliance} color="green" size={42} />
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#1a1c23] rounded-2xl shadow-sm border border-gray-200 dark:border-white/5 p-6 min-h-[160px] md:min-h-[200px] transition-all duration-300 relative overflow-hidden flex flex-col justify-between">
          ...
          <div className="absolute bottom-4 right-4 sm:bottom-6 sm:right-6">
            <CircularProgress percentage={salsasUnits > 0 ? 100 : 0} color="amber" size={42} />
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#1a1c23] rounded-2xl shadow-sm border border-gray-200 dark:border-white/5 p-6 min-h-[160px] md:min-h-[200px] transition-all duration-300 relative overflow-hidden flex flex-col justify-between">
          <div className="space-y-2 sm:space-y-4">
            ...
            <div className="pt-2 border-t border-gray-100 dark:border-white/5">
              ...
              <h3 className={`text-lg sm:text-xl font-bold mt-1 ${difference >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
